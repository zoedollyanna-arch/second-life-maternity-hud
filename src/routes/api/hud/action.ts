...
const WEB_ACTIONS = new Set([
  "drink_water", "eat", "food_eat", "rest", "vitamins", "bathroom", "comfort",
  "hug", "support", "doctor", "kick", "memory", "journal_add", "event",
  "symptom_log", "settings_update", "notifications_read",
  "daily_checkin", "hold_belly", "ultrasound", "appointment", "baby_size",
  "heartbeat", "talk_to_baby", "baby_position", "breathe", "warm_bath",
