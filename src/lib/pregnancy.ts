...
export const BABY_GROWTH: BabyMilestone[] = [
  {
    ...
    lengthCm: 0.2,
    weightG: 0.5,
    note: "The journey begins — a tiny spark of life.",
  },
  {
    week: 6,
    size: "Sweet pea",
    lengthCm: 0.6,
    weightG: 1,
    note: "A little heart begins to flutter.",
  },
  {
    week: 8,
    size: "Raspberry",
    lengthCm: 1.6,
    weightG: 2,
    note: "Tiny fingers and toes are forming.",
  },
  {
    week: 10,
    size: "Strawberry",
    lengthCm: 3.1,
    weightG: 4,
    note: "All vital organs are in place.",
  },
  {
    week: 12,
    size: "Lime",
    lengthCm: 5.4,
    weightG: 14,
    note: "Reflexes are developing — hello little wiggles.",
  },
  { week: 14, size: "Lemon", lengthCm: 8.7, weightG: 43, note: "Baby can squint and frown now." },
  {
    ...
    lengthCm: 11.6,
    weightG: 100,
    note: "You may feel the first flutters soon.",
  },
  {
    week: 18,
    size: "Bell pepper",
    lengthCm: 14.2,
    weightG: 190,
    note: "Little ears can hear your voice.",
  },
  {
    week: 20,
    size: "Banana",
    lengthCm: 25.6,
    weightG: 300,
    note: "Halfway there! Baby is getting stronger.",
  },
  {
    week: 22,
    size: "Papaya",
    lengthCm: 27.8,
    weightG: 430,
    note: "Baby responds to sound and touch.",
  },
  {
    week: 24,
    size: "Cantaloupe",
    lengthCm: 30.1,
    weightG: 650,
    note: "Kicks are getting easier to feel.",
  },
  {
    week: 26,
    size: "Lettuce head",
    lengthCm: 35.6,
    weightG: 760,
    note: "Little eyes are starting to open.",
  },
  {
    week: 28,
    size: "Eggplant",
    lengthCm: 37.6,
    weightG: 1000,
    note: "Third trimester — baby can dream now.",
  },
  {
    week: 30,
    size: "Cabbage",
    lengthCm: 39.9,
    weightG: 1300,
    note: "Baby practices breathing movements.",
  },
  {
    week: 32,
    size: "Squash",
    lengthCm: 42.4,
    weightG: 1700,
    note: "Getting chubby and cozy in there.",
  },
  {
    week: 34,
    size: "Pineapple",
    lengthCm: 45,
    weightG: 2100,
    note: "Baby is likely settling head-down.",
  },
  {
    week: 36,
    size: "Honeydew melon",
  ...
  },
  {
    ...
    lengthCm: 51.2,
    weightG: 3400,
    note: "Welcome to the world, little one ♥",
  },
];
